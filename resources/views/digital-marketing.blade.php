...
{{-- SEO Tags --}}
  ...
  <link rel="stylesheet" href="{{ asset('assets/css/digital-marketing.css') }}">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasOne">
      ...
      <div class="offcanvas__body">
        <div class="offcanvas__logo">
          ...
          <p>Freelance Digital Marketer in Malappuram with Extensive Experience in SEO, Web Designing, Social Media Marketing, etc.</p>
        </div>
      ...
      <div class="body-wrapper">
          ...
          <section class="pt-190 pb-150">
            <div class="container">
              <div class="dancer__classDetailHero-wrapper">
                <h1 class="dancer__classDetailHero-title text-uppercase has_text_reveal_anim" data-on-scroll="0">Digital Marketing
                </h1>
                <h2 class="dancer__classDetailHero-dis text-uppercase has_text_reveal_anim" data-on-scroll="0">
                 Digital Marketing Expert in Malappuram</h2>
                <div class="detail-thumb-anim cf_image mt-70 mb-60" style="height: 70vh;">
                  <img src="{{ asset('assets/imgs/media/digital_marketing_in_malappuram.webp') }}" alt="Freelance Digital Marketer in Malappuram" data-speed="auto">
                </div>




          <!-- CUSTOM CONTENT MY OWN -->
        ...
        <div class="expertise-content">
            <div class="expertise-column">
                <p class="expertise-column p"><b>Salman MP here,</b> your dedicated Digital Marketing Strategist based in Malappuram, Kerala, India. With years of hands-on experience in digital marketing, including expertise in social media marketing and search engine optimization (SEO), 
            ...
            <div class="developer-about__img">
                                                            <div class="cf_image has_fade_anim">
                                                                <img src="{{ asset('assets/imgs/about/personal-photo-about.webp') }}" alt="About Salman MP - SEO Specialist in Malappuram" class="about-me">
                                                            </div>
                                                            <div class="cf_image has_fade_anim">
