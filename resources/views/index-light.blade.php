...
<body class="font-heading-estedad light">
    ...
    <div class="switcher__items">
      <div class="switcher__item">
        ...
        <div class="switcher__btn mode-type wc-col-2">
          <button data-mode="dark" aria-label="active">dark</button>
          <button class="active" data-mode="light" aria-label="light">light</button>
        </div>
      </div>
  ...
  <header class="header__area-2">
    <div class="header__inner-2">
      ...
      <div class="copyright">
        <p>© Alrights reserved <br> by <a href="https://crowdyflow.com/" target="_blank">CrowdyFlow</a></p>
      </div>
    </div>
  </header>
  <!-- Header area end -->
    ...
    <div id="smooth-content">
      <div class="body-wrapper">
        ...
        <main class="sidebar-left">
          ...
          <div class="pd-header">
            <a href="index.html">
              <img src="../assets/imgs/logo/site-logo-light.png" alt="Site Logo">
            </a>
            <button class="header__navicon-2">
              <img id="header_navicon_2" class="icon" src="../assets/imgs/logo/menu-icon-white.png" alt="Icon">
            </button>
          </div>
              ...
              <div class="row">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                  <div class="pdesigner-hero__left">
                    ...
                    <div class="pb-30">
                      <h2 class="pdesigner-hero__title has_text_move_anim" data-delay=".7">A Digital
                        <span>Product</span>
                        Designer
                      </h2>
                    </div>
                    <div class="cf_btn has_fade_anim" data-fade-from="top" data-delay="1" data-ease="bounce">
                      <a href="portfolio-light.html" class="btn-hover-mask" data-text="View My Works">View My
                        Works</a>
                    </div>
                  </div>
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                  <div class="pdesigner-hero__right">
                    <div class="pdesigner-hero__text">
                      ...
                      <div class="cf-text has__anim" data-delay="1.2">
                        <p>A Freelance UI/UX Designer and Developer <span>based in Germany</span>. I strives to build
                  ...
                  <div class="mixitup-active">
                    <div class="pdesigner-portfolio__flex has_pdportfolio_animation">
                      <div class="pdesigner-portfolio__item mix creative">
                        <a href="portfolio-details-light.html">
                          <img src="../assets/imgs/portfolio/3.jpg" alt="Portfolio Thumbnail">
                        </a>
                        <div class="pdesigner-portfolio__content">
                          <ul>
                            <li><a href="#" class="pdesigner-portfolio__category">UI
                                Design</a> </li>
                            <li><a href="portfolio-details-light.html" class="pdesigner-portfolio__title">User
                                Experience</a></li>
                          </ul>
                        </div>
                      </div>
              ...
              <div class="row">
                <div class="col-xxl-12">
                  <div class="cf_btn wc-btn has_fade_anim" data-fade-from="top" data-ease="bounce">
                    <a href="portfolio-light.html" class="btn-hover-mask">Load more works <i
              ...
              <div class="row">
                <div class="col-xx-l-4 col-xl-4 col-lg-4 col-md-4">
                  <article class="has_fade_anim" data-fade-from="left">
                    <div class="pdesigner-blog__item pdesigner__blog-hover">
                      <a href="blog-details-light.html"><img src="../assets/imgs/blog/4.jpg" alt="Blog Thumbnail"></a>
                      <div class="pdesigner-blog__content">
                        <div>
                          ...
                          <a href="blog-details-light.html" class="pdesigner-blog__link">Read More
                ...
                <div class="col-xx-l-4 col-xl-4 col-lg-4 col-md-4">
                  <article class="has_fade_anim" data-fade-from="left" data-delay="0.8">
                    <div class="pdesigner-blog__item pdesigner__blog-hover">
                      <a href="blog-details-light.html"><img src="../assets/imgs/blog/8.jpg" alt="Blog Thumbnail"></a>
                      <div class="pdesigner-blog__content">
                        <div>
                          <ul class="pdesigner-blog__meta">
                            <li><a href="#">Ui design</a></li>
                ...
                <div class="col-xx-l-4 col-xl-4 col-lg-4 col-md-4">
                  <article class="has_fade_anim" data-fade-from="left" data-delay="1.1">
                    <div class="pdesigner-blog__item pdesigner__blog-hover">
                      <a href="blog-details-light.html"><img src="../assets/imgs/blog/9.jpg" alt="Blog Thumbnail"></a>
                      <div class="pdesigner-blog__content">
                        <div>
                          <ul class="pdesigner-blog__meta">
                            <li><a href="#">Ui design</a></li>
